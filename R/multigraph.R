...
function (net, layout = c("circ", "force", "stress", "rand"), 
    outline, directed = TRUE, main = NULL, seed = NULL, maxiter = 100, 
    alpha = c(1, 1, 1), collRecip, showLbs, showAtts, weighted, 
    cex.main, coord, clu, cex, lwd, pch, lty, bwd, tcol, tcex, 
    att, bg, mar, pos, asp, ecol, vcol, vcol0, hds, vedist, rot, 
    mirrorX, mirrorY, col, lbat, drp, ...) 
{
